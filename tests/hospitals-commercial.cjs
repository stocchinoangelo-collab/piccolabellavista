...
(async()=>{
 ...
 for(const width of [390,768,1440]){
  ...
  for(const lang of ['it','en','de']){
   ...
   assert.equal(await page.locator('a[href="https://wa.me/393931104422"]').count(),1);
   ...
   await page.locator('a[href="https://wa.me/393931104422"]').click();await page.waitForURL('https://wa.me/393931104422');
